...
//     id: 1,
//     name: "Beka T.",
//     text: "I am pleased with the quality Yai Softwares and its team has produced on my project and your Project Management capability. This team has excellent communication skills and quick response with fast turnaround time has really impressed me.",
//     rating: 5,
//   },
//   {
//     id: 2,
...
export default function PartnershipSection() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-16">
      ...
      {/* Right Column - Testimonials & Awards */}
      {/* <div className="bg-[#fdfbf4] p-8 rounded-xl flex flex-col justify-between">
